...
namespace ews {
    namespace app {
        namespace drawable {
            ...
            : MatrixManipulator(), _distance(1.0) {
            ...
            void CameraController::setNode(osg::Node* node) {
                _node = node;
            ...
            const osg::Node* CameraController::getNode() const
            {
                return _node.get();
            }
            
            
            osg::Node* CameraController::getNode()
            {
                return _node.get();
            }
            ...
            bool CameraController::intersect(const osg::Vec3d& start, const osg::Vec3d& end, osg::Vec3d& intersection) const
            {
            ...
            void CameraController::home(const GUIEventAdapter& ,GUIActionAdapter& us)
            {
                if (getAutoComputeHomePosition()) computeHomePosition();
            ...
            void CameraController::init(const GUIEventAdapter& ,GUIActionAdapter& )
            {
                flushMouseEventStack();
            }
            
            
            void CameraController::getUsage(osg::ApplicationUsage& usage) const
            {
                usage.addKeyboardMouseBinding("CameraController: Space","Reset the viewing position to home");
            }
            ...
            void CameraController::flushMouseEventStack()  {
                _ga_t1 = NULL;
                _ga_t0 = NULL;
            }
            
            
            void CameraController::addMouseEvent(const GUIEventAdapter& ea) {
                _ga_t1 = _ga_t0;
                _ga_t0 = &ea;
            }
            void CameraController::setByMatrix(const osg::Matrixd& matrix) {
...
//                Matrixd inv = getMatrix();
//                
//                osg::Vec3d pos = Vec3d() * inv;
//                osg::notify(osg::INFO) << "position: " << pos << "\n";
            }
             ...
             * (-1.0 ... 1.0)
             */
            void CameraController::trackball(osg::Vec3& axis,double & angle, double  p1x, double  p1y, double  p2x, double  p2y) {
                /*
             ...
             */
            double CameraController::tb_project_to_sphere(double  r, double  x, double  y) {
                float d, t, z;
